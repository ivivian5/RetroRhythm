...
// Netlist written on Tue Dec 10 00:50:54 2024
...
module mypll (ref_clk_i, rst_n_i, outcore_o, outglobal_o) /* synthesis ORIG_MODULE_NAME="mypll", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input ref_clk_i;
    input rst_n_i;
    output outcore_o;
    output outglobal_o;
